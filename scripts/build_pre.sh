...
apollo_config_db_url=jdbc:mysql://10.29.216.68:3307/ApolloConfigDB?characterEncoding=utf8
apollo_config_db_username=apollo_upay
apollo_config_db_password=rH8k7qDPNam5w3B5

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://10.29.216.68:3307/ApolloPortalDB?characterEncoding=utf8
...
~
~
"build_pre.sh" 46L, 1857C                                                                                                                                                                        46,0-1        All
